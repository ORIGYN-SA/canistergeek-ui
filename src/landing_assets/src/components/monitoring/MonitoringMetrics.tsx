...
import {CanistergeekMetricsPage, DataProvider, PrecalculatedPredictionDataProvider, PrecalculatedRealtimeDataProvider, PrecalculatedTrendDataProvider} from "canistergeek-js";
