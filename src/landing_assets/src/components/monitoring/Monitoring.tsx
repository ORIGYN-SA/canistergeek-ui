import {ConfigurationLocalStorageProvider, ConfigurationProvider, PageLoaderComponent, URLPathProvider, useConfigurationContext, useConfigurationStorageContext} from "canistergeek-js";
...
import {Canister} from "canistergeek-js/lib/es5/dataProvider/ConfigurationProvider";
import {BLACKHOLE_CANISTER_ID} from "canistergeek-js/lib/es5/api/blackhole0_0_0";
